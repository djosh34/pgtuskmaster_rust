...
For example: the Diátaxis approach recommends that [the architecture of reference documentation should reflect the architecture of the code it documents](<../reference/#respect-structure>). This makes gaps in the documentation much more clearly visible.
