...
![Explanation - understanding oriented, theoretical knowledge, that serves our study](../_images/overview-explanation.png)
...
Your explanation documentation doesn’t need to be called _Explanation_. Alternatives include:
