Write exactly one Markdown page for `docs/src/overview.md`.

Requirements:
- This is the main landing page for the mdBook docs set.
- It must orient first-time readers, explain the four documentation areas using the Diataxis framing supplied below, and link into the actual docs that exist in this repository.
- Prefer concrete navigation over generic prose.
- Keep claims grounded in the provided raw context only.
- Use relative links appropriate for `docs/src/overview.md`.
- Do not write any text outside the page body.

Target links that should appear naturally in the page:
- `tutorial/overview.md`
- `how-to/overview.md`
- `explanation/overview.md`
- `reference/overview.md`
- `tutorial/first-ha-cluster.md`
- `how-to/check-cluster-health.md`
