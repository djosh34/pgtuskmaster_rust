...
Compass classification: `cognition + acquisition` because this page explains why recovery is split into multiple paths and what each path means in the design.
