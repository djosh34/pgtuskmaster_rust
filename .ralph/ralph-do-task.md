...
- [ ] complete the work like this:
    - [ ] Plan first the full solution out in detail (using 20+ explore_spark subagents in parallel to speed up the research phase)
    ...
    - [ ] If you read 'TO BE VERIFIED', do a DEEP and SKEPTICAL review of the plan, you must alter at least one thing in the plan, otherwise your research was not deep enough. (Also use 20+ explore_spark subagents in parallel for this DEEP SKEPTICAL VERIFICATION)
