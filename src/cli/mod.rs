...
pub async fn run(cli: Cli) -> Result<String, CliError> {
    ...
    let client = CliApiClient::new(cli.base_url, cli.timeout_ms, cli.read_token, cli.admin_token)?;
...
mod tests {
    ...
    fn exit_code_mapping_is_stable() {
        ...
        assert_eq!(CliError::ApiStatus { status: 500, body: "x".to_string() }.exit_code(), 4.into());
