...
pub use schema::{
    ...
    DcsTlsConfig, DebugConfig, FileSinkConfig, FileSinkMode, HaConfig, InlineOrPath,
    LogCleanupConfig, LogLevel, LoggingConfig, LoggingSinksConfig, PgtmApiAuthConfig,
    PgtmApiConfig, PgtmApiTransportExpectation, PgtmClientTlsConfig, PgtmConfig,
    PgtmPostgresConfig, PgtmPrimaryTargetConfig, PostgresAccessConfig, PostgresBinaryName,
    PostgresClientTransportConfig, PostgresConfig, PostgresLoggingConfig, PostgresNetworkConfig,
    PostgresPathsConfig, PostgresRewindConfig, PostgresRoleConfig, PostgresRolesConfig,
